...
public class TestDB extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        ColumnHashSet.add(MovieContract.MovieEntry.COLUMN_IMAGE);
        ColumnHashSet.add(MovieContract.MovieEntry.COLUMN_TITLE);
        ColumnHashSet.add(MovieContract.MovieEntry.COLUMN_OVERVIEW);
        ColumnHashSet.add(MovieContract.MovieEntry.COLUMN_VOTE);
        ColumnHashSet.add(MovieContract.MovieEntry.COLUMN_DATE);
